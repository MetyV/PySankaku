...
class PostData(BaseModel):
      ...
      preview_width                  : Optional[int]  = Field(None, description="")
      preview_height                 : Optional[int]  = Field(None, description="")
      ...
      video_duration                 : Optional[float]  = Field(None, description="")
